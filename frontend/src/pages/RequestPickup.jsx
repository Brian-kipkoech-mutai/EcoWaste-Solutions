...
function RequestPickup({
  ...
  return (
    <div className="flex   lg:gap-6 justify-center md:justify-between  max-w-screen-xl    mx-auto p-3 py-6 ">
      <form
        onSubmit={handleSubmit}
        className="py-4  px-2 lg:px-10 flex flex-col gap-6  border  w-full  max-w-screen-sm bg-gray-100 rounded-md shadow-xl"
      >
      ...
      <motion.div
        className="hidden md:block   h-fit self-end"
        initial={{
          opacity: 0,
          x: "-100vw",
        }}
      ...
      >
        <svg
          ...
          data-name="Layer 1"
          className="w-52 h-64 md:w-96  lg:w-112 lg:h-96 "
        ...
        >
          ...
          <path
            ...
            fill="#e6e6e6"
          />
          <circle cx="420.52193" cy="415.57596" r="7.40884" fill="#25ad33" />
          ...
          <circle cx="153.50003" cy="23.86253" r="11.93126" fill="#25ad33" />
          <polygon
