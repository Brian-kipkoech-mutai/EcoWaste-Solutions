   ...
   function PersonCard({initials,name,description,img}) {
    return (
        ...
        <section className="flex items-center gap-4">
          <Avatar className="h-full w-20 md:h-h-14 md:w-14 md:rounded-full rounded-sm shadow-xl ">
            <AvatarImage
              src={img}
              className="object-cover md:object-contain "
            />
            <AvatarFallback className=" h-full w-full md:h-14 md:w-14 font-semibold tracking-wider rounded-none md:rounded-full bg-green-600 text-white group-hover:bg-green-700">
              {initials}
            </AvatarFallback>
          </Avatar>
